          ...
          <div class="x_content">
            <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
              <div class="profile_img">
                <div id="crop-avatar">
                  <!-- Current avatar -->
                  <img class="img-responsive avatar-view" src="<?= base_url('assets/gentelella/images/img.jpg') ?>" alt="Avatar" title="Change the avatar">
                </div>
              </div>
              <h3>Mirian</h3>

              <ul class="list-unstyled user_data">
                <li><i class="fa fa-map-marker user-profile-icon"></i> Georgia, Rustavi
                </li>
                ...
                <li class="m-top-xs">
                  ...
                  <a href="https://www.linkedin.com/in/mirian-kotchlamazashvili-2489601a0/" target="_blank">Linkedin</a>
                </li>
              </ul>
