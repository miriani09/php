...
if (isset($_POST['submit'])){
    ...
    $select_query = "SELECT name,password FROM administrator WHERE name = '".$user."' AND password = '".$password."'";
...
<body>
<h1 style="text-align: center"><a href="../index.php" class="link">Applicant</a></h1>
<hr>
